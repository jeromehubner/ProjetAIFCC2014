...
public class UserBdd {
	...
	/**
	 * @brief ins�re un utilisateur dans la base de donn�es
	 * @param l'utilisateur � ins�rer
	 */
	...
	/**
	 * @brief met � jour un utilisateur dans la base de donn�es
	 * @param l'utilisateur � mettre � jour
	 */
	...
	/**
	 * @brief supprime un utilisateur dans la base de donn�es
	 * @param l'utilisateur � supprimer
	 */
	 ...
	 * @return l'utilisateur contenu en base de donn�es correspondant � l'identifiant pass� en param�tre
	 */
